...
| UX flow clarity, visual hierarchy, or interaction consistency degrades | Run UI/UX Specialist gate (`.github/agents/ui-ux-specialist-gate.md`) | UX/UI Specialist + Reviewer | P0 |
| Agent workflow, model strategy, or best-practice alignment changes are proposed | Run Research Strategy gate (`.github/agents/research-strategy-gate.md`) | Research Specialist + Reviewer | P0 |
